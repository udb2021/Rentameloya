...
<br>
	<div class="page-header">
    	<h1 class="h2">Catalogo de Automoviles. / <a class="btn btn-success" href="addnew.php"> <span class="glyphicon glyphicon-plus"></span> &nbsp;Agregar nuevo </a></h1> 
    </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<li>
				...
				<a class="btn btn-info" href="editform.php?edit_id=<?php echo $row['id_coche']; ?>" title="click para editar" onclick="return confirm('seguro que desea editar ?')"><span class="glyphicon glyphicon-edit"></span> Editar</a> 
				<a class="btn btn-danger" href="?delete_id=<?php echo $row['id_coche']; ?>" title="click para eliminar" onclick="return confirm('seguro que desea eliminar ?')"><span class="glyphicon glyphicon-remove-circle"></span> Eliminar</a>
			</li>			
