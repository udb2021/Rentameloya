...
<div class="content">
 ...
 <form action="eliminarcliente.php" method="POST" name="formu">
<?php
$id=null;
if (!empty($_GET)) {
$id=$_GET['id'];
...
echo '
 <div>
 <label for="-"></label>
 <input type="text" value="'.$data["id_cliente"].'" class="form-control" readonly="readonly" name="id_cliente">
 </div>
 <div>
 <label for="-"></label>
 <input type="text" value="'.$data["nombre"].'" placeholder="Nombre " class="form-control" name="nombre" readonly="readonly">
 </div>
 <div>
 <label for="-"></label>
 <input type="text" value="'.$data["apellido"].'" placeholder="Apellido" class="form-control" name="apellido" readonly="readonly">
 </div>
<br>
';
Database::disconnect();
...
if (!empty($_POST)) {
 ...
 $query = $cnu->prepare("delete from clientes where id_cliente = ?");
